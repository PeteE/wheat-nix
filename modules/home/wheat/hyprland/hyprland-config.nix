...
let 
  text = ''
    ...
    exec-once = $terminal & $browser & waybar & hyprshell run
    ...
    # rofi
    # bind = $mainMod SHIFT, F, rofi-window
    # bind = $mainMod SHIFT, R, rofi-launcher
    bind = $mainMod SHIFT, A, exec, ${pkgs.wheat.rofi-scripts}/bin/rofi-clipboard
    bind = $mainMod SHIFT, R, exec, ${pkgs.wheat.rofi-scripts}/bin/rofi-launcher
